...
for lang in grn_all_mor_preprocessed grn_all_mor_preprocessed_no_at grn_all_mor_preprocessed_more_at grn_all_bpe_500_preprocessed grn_all_bpe_500_preprocessed_no_at grn_all_bpe_500_preprocessed_more_at ; do
	for input_size in char ; do

	CUDA_VISIBLE_DEVICES=2 python main.py --cuda --epochs 50 --nlayers 3 --emsize 400 --nhid 1840 --alpha 0 --beta 0 --dropoute 0 \
