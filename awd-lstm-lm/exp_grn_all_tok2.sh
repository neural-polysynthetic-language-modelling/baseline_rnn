...
for lang in grn_all_tok_bpe_500_preprocessed_no_at grn_all_tok_bpe_500_preprocessed_more_at grn_all_tok_mor_preprocessed_no_at grn_all_tok_mor_preprocessed_more_at ; do
