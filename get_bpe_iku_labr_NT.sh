#!/bin/bash
source_path="/home/hpark129/projects/JSALT_NPLM_data/Inuit-Yupik/iku_labr/bible_preprocess/output/NT"
output_path_iku="/home/hpark129/projects/JSALT_NPLM_data/baseline_RNN/data/iku_labr_NT"
...
for bpe_size in 500 1000 5000 15000 30000 60000; do
    for prefix in train dev test; do
        ...
        cp ${source_path}/bpe/${bpe_size}/${prefix}.bpe.${bpe_size}.iku_labr ${output_path_iku}_bpe_${bpe_size}/${prefix}.txt
        fi
    done
